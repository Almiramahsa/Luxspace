...
export default function ErrorMessage({ title = '404 NOT FOUND', body = 'Sorry, but the page you were trying to view does not exist.' }) {
  return (
    <section className="">
      <div className="container mx-auto min-h-screen">
        <div className="flex flex-col items-center justify-center">
          <div className="w-full md:w-4/12 text-center">
            <img src="/images/content/404.svg" alt="Success Payment illustration" />
